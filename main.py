...
workspace.add_obstacle( Box(Frame2D(0, -4, 5), 1, 1) )
workspace.add_obstacle( Box(Frame2D(0, 2, 1), 1, 1) )
workspace.add_obstacle( Box(Frame2D(np.pi/5, 3, 5), 2, 2) )
workspace.add_obstacle( Box(Frame2D(0, -2, 1), 1, 1) )

workspace.add_box(-4, 1)
workspace.add_box(4, 1)
workspace.add_box(0, 6)
...
rrt = RRT(workspace, 0.15, 0.2, limits)
